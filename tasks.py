...
def collect_task(self):
    try:
        from core.pipeline import run_collect
        run_collect()
...
def analyze_task(self, limit=None, min_mentions=None):
    try:
        from core.pipeline import run_analyze
...
def generate_task(self):
    try:
        from core.pipeline import run_generate
        run_generate()
    except Exception as exc:
...
def momentum_task(self):
    try:
        from core.pipeline import run_momentum
        run_momentum()
    except Exception as exc:
